...
def build_vocab(name, dataset_list, cache_path, word_vec_path=None, feat_dim=None):
    ...
    if not os.path.exists(cache_path):
        ...
        for dataset in dataset_list:
            logging.info('    indexing words from {}'.format(dataset.lmdb_dir+ dataset.loader_type+ f"_pickle/"  ))
            index_words(lang_model, dataset.lmdb_dir+ dataset.loader_type+ f"_pickle/")
