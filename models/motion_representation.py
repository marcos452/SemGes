...
class VQVAEConvZero_1(nn.Module):
    def __init__(self, args):
        super(VQVAEConvZero_1, self).__init__()
        self.encoder = VQEncoderV8(args)
        self.quantizer = QuantizerV8(args.vae_codebook_size, args.vae_length, args.vae_quantizer_lambda)
